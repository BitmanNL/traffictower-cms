 ...
 */
class SharpenFilter implements Image\Filters\FilterInterface
{
    /**
     * @var int $amount The amount of the sharpening strength to apply to the
     *                  image.
     */
    private $amount;

    /**
     * Construct a new SharpenFilter
     *
     * @param int $amount The amount of the sharpening strength to apply to the
     *                    image.
     */
