...
/**
 * An Intervention Image filter for creating thumbnails
 *
 * An Intervention Image filter for creating thumbnails with a dimension of
 * 100x100 pixels.
 */
class ThumbnailFilter implements Image\Filters\FilterInterface
{
    /**
