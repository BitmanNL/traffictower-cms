...
/**
 * An Intervention Image filter for changing images their brightness
 */
class BrightnessFilter implements Image\Filters\FilterInterface
{
    /** @var int $level The brightness level (-100-100) to apply to the image. */
    private $level;

    /**
     * Construct a new BrightnessFilter
     *
     * @param int $level The brightness level to apply to the image.
     */
