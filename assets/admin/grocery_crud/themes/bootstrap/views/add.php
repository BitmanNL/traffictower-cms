...
$this->set_js_config($this->default_theme_path.'/bootstrap/js/app/twitter-bootstrap-add.js');
...
<div class="twitter-bootstrap crud-form row">
	...
	<h3><?php echo $this->l('form_add'); ?> <?php echo $subject?></h3>
		...
		<div id="main-table-box">
			<?php echo form_open( $insert_url, 'method="post" id="crudForm" class="form-div" autocomplete="off" enctype="multipart/form-data" onsubmit="return false"'); ?>
				<table class="table">
				<tbody>
				...
				<div class="pull-right">
					...
					<?php } ?>
					<?php 	if(!$this->unset_back_to_list) { ?>
						<input type="button" value="<?php echo $this->l('form_save'); ?>" id="save-and-go-back-button" class="btn btn-success"/>
					<?php 	} ?>
				</div>
