...
<div class="twitter-bootstrap crud-form row">
	<div class="col-md-12">
		...
		<div id="main-table-box">
			<?php echo form_open( $read_url, 'method="post" id="crudForm" class="form-div" autocomplete="off" enctype="multipart/form-data"'); ?>
			...
			<div class="pull-right">
				<input type="button" value="<?php echo $this->l('form_back_to_list'); ?>" class="btn btn-default back-to-list" id="cancel-button" />
			</div>
